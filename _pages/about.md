...
# 📝 Publications
**2024:**
- Ruosen Li, **Zimu Wang**, Son Quoc Tran, Lei Xia, and Xinya Du. MEQA: A Benchmark for Multi-hop Event-centric Question Answering with Explanations. *The Thirty-Eighth Annual Conference on Neural Information Processing Systems* (**NeurIPS 2024**).
- **Zimu Wang**, Lei Xia, Wei Wang, and Xinya Du. Document-level Causal Relation Extraction with Knowledge-guided Binary Question Answering. *Findings of the Association for Computational Linguistics: EMNLP 2024* (**EMNLP 2024 Findings**).
